...
1. Unity 2D project with Android build support.
2. Landscape arena scene.
3. On-screen joystick and combat buttons.
...
Character names should be treated as fictional arcade characters inspired by first names only. Avoid photos, school names, class details, addresses, or anything identifying real children.
